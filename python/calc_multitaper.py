...
data_files = sorted(
    glob(
        "/well/woolrich/projects/uk_meg_notts/eo/oslpy22/src/*/sflip_parc-raw.fif"
    )
)
data = Data(
    data_files, picks="misc", reject_by_annotation="omit", n_jobs=8
)
