...
% As the output from mark_edit_header
% sets an invalid code which rhino will not like.
% See convert_mri for more on this
offset=[128 -128 -90];
[in,out] = mark_edit_header( niftiFileName, fullfile(pth,nm), nii.hdr.dime.pixdim(2:4), offset, -1 );

%%%%%%% 
% added by MWW Aug 2019
%%%%%%% 
% add correct sform code.
% the output from mark_edit_header has an invalid qform and
